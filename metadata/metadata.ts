...
const ICONS = {
  ...
  GOOGLE_CLOUD: 'googlecloud-plain',
...
export const metadata: Metadata = {
  ...
  personalInformation: {
    ...
    experience: [
      {
        ...
        description: [
          "Leading the Admin Portal UI rework across the Events & Shifts and the Form Templates domain on the Laravel/Vue 2 monolith, working iteratively with product and design team to reduce admin user's time on building forms.",
          'Strengthening reliability and observability across the Laravel monolith through custom OpenTelemetry instrumentation, uncovering and closing out a run of production third party integration defects.',
          'Built safe guards for destructive actions into the Rosterfy AI Agent project via pre-execution impact summary and consistent confirmation flows, enabling the business to extend the agent platform to higher-stakes workflow.',
          'Tech stack: PHP (Laravel), TypeScript (Vue, React, React Native, Expo, Express, Vercel AI SDK, MCP SDK), MySQL, Redis/Valkey, AWS (SQS, DynamoDB, EventBridge, CDK), GitHub Actions, BuildKite, OpenTelemetry, Playwright',
        ],
        techIcons: [
          ICONS.JS,
          ICONS.TS,
    ...
    projects: [
      ...
      {
        title: 'Starter Kit',
        description: 'Opinionated Starter kit from yours truly for all my other projects',
        url: 'https://github.com/samhwang/starter-kit',
      },
      {
        title: 'My Resume page',
        description: "The page you're viewing right now! Hosted on Cloudflare Workers, built with the Vite & React. Scaffolded from the above Starter Kit",
        url: 'https://me.samh.page',
      },
      {
    ...
    skills: [
      {
        ...
        description: [
          ...
          'Version control with Git and collaboration: GitHub, BitBucket',
          ...
          'Services tracing & error monitoring tools: Sentry, Datadog, Honeycomb',
          'Project Management tools: JIRA, Confluence, Trello, Asana',
          'IDE: Visual Studio Code, JetBrains IDE (IntelliJ IDEA, PHPStorm, WebStorm)',
