    ...
    experience: [
      {
        ...
        description: [
          "Maintain Lyka's main website, journal and ordering pages and backend API as part of Acquisition squad duties.",
          'Integrate Segment as a customer data analytics platform',
          'Take part in on-call duties to maintain 99.99% service uptime over busy periods.',
        ],
        technologies: [
